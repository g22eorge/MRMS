...
function cachedSystem(): string {
  return [
    ...
    "finance.cashMarginSignal — cashReceived minus externalRepairCost minus expenses. Negative means more went out than came in this month. It is a cash signal, not accounting profit: it ignores unpaid invoices and stock already bought.",
