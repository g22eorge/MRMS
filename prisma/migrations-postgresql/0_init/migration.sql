...
CREATE TABLE "Job" (
    ...
    "externalTechFee" DOUBLE PRECISION,
...
CREATE TABLE "CreditNoteItem" (
    ...
    "saleUomFactor" DOUBLE PRECISION,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "Part" (
    ...
    "purchaseUom" TEXT,
    "saleUomFactor" DOUBLE PRECISION,
    "purchaseUomFactor" DOUBLE PRECISION,
...
CREATE TABLE "OneTimeExternalTechAssignment" (
    ...
    "phone" TEXT NOT NULL,
    "specialization" TEXT,
    "agreedRepairCost" DOUBLE PRECISION,
    "partsNotes" TEXT,
    "expectedPartsCost" DOUBLE PRECISION,
...
CREATE TABLE "DocumentBrandingSettings" (
    ...
    "vatRatePercent" DOUBLE PRECISION NOT NULL DEFAULT 18,
...
CREATE TABLE "SupplierPayment" (
    ...
    "baseAmountSent" DOUBLE PRECISION,
    "method" "PaymentMethod" NOT NULL DEFAULT 'CASH',
    "reference" TEXT,
    "paidAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "note" TEXT,
...
CREATE TABLE "PosSession" (
    ...
    "mobileTotal" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE "PaymentReminderSettings" (
    ...
    "manualReviewAbove" DOUBLE PRECISION NOT NULL DEFAULT 2000000,
