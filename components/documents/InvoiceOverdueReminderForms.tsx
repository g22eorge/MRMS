...
export function InvoiceOverdueReminderBulkButton({
  ...
  return (
    <form action={sendOverdueInvoiceRemindersBulkAction} className="inline-flex">
      ...
      <button
        type="submit"
        className="rounded-lg border border-amber-500/40 bg-amber-500/10 px-3 py-1.5 text-[0.75rem] font-bold text-amber-800 transition hover:bg-amber-500/20 dark:text-amber-300"
      >
