...
const inputClass =
  "w-full rounded-lg border border-[var(--line)] bg-[var(--panel-strong)] px-3 py-1.5 text-[13px] outline-none focus:border-[var(--accent)]/50 focus:ring-2 focus:ring-[var(--accent)]/14";
  ...
  return (
    <div className="grid gap-3">
          ...
          <div className="mb-2 flex items-center justify-between">
            ...
            {accounts.length > 1 ? (
              <button
                type="button"
                onClick={() => remove(i)}
                className="text-[12px] font-medium text-red-600 hover:underline dark:text-red-400"
              >
                Remove
              </button>
            ) : null}
      ...
      <button
        type="button"
        onClick={add}
        className="justify-self-start rounded-lg border border-dashed border-[var(--line)] px-3 py-1.5 text-[13px] font-medium text-[var(--ink)] transition hover:border-[var(--accent)]/50"
      >
