...
export function PrintReportButton({ label = "Print / PDF" }: { label?: string }) {
  return (
    <button
      ...
      className="no-print inline-flex items-center gap-1.5 rounded-lg border border-[var(--line)] px-3 py-1.5 text-[0.8125rem] font-semibold text-[var(--ink)] transition hover:border-[var(--accent)]/50 hover:text-[var(--accent)]"
    >
