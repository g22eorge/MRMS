...
const TONES: Record<BadgeTone, { badge: string; dot: string }> = {
  ...
  warning: { badge: "border-amber-400/30 bg-amber-500/10 text-amber-800 dark:text-amber-400", dot: "bg-amber-500" },
  danger:  { badge: "border-red-400/30 bg-red-500/10 text-red-700 dark:text-red-400",         dot: "bg-red-500" },
  accent:  { badge: "border-[var(--accent)]/40 bg-[var(--accent)]/10 text-[#665214] dark:text-[var(--accent)]", dot: "bg-[var(--accent)]" },
  violet:  { badge: "border-slate-400/30 bg-slate-500/10 text-slate-700 dark:text-slate-400", dot: "bg-slate-500" },
  sky:     { badge: "border-sky-400/30 bg-sky-500/10 text-sky-700 dark:text-sky-400",         dot: "bg-sky-500" },
  purple:  { badge: "border-slate-400/30 bg-slate-500/10 text-slate-700 dark:text-slate-400", dot: "bg-slate-500" },
  ...
  orange:  { badge: "border-amber-400/30 bg-amber-500/10 text-amber-800 dark:text-amber-400", dot: "bg-amber-500" },
