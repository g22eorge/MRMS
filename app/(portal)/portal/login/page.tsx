    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          <p className="text-[0.75rem] font-bold uppercase tracking-[0.18em] text-[var(--accent)]">Client Portal</p>
          <h1 className="mt-1 text-xl font-black text-[var(--ink)]">Sign in to track your repairs</h1>
          <p className="mt-1 text-[0.8125rem] text-[var(--ink-muted)]">Use the credentials your service provider gave you.</p>
        </div>
