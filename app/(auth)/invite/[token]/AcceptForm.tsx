    ...
    <form action={action} className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none transition placeholder:text-white/45 focus:border-[#C9A227]/50 focus:ring-2 focus:ring-[#C9A227]/15"
        />
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 pr-20 text-sm text-white outline-none transition placeholder:text-white/45 focus:border-[#C9A227]/50 focus:ring-2 focus:ring-[#C9A227]/15"
          />
          <button
            type="button"
