      ...
      <div className="grid min-h-dvh grid-cols-1 lg:grid-cols-[1fr_1fr]">
        ...
        <section className="relative hidden flex-col justify-between overflow-hidden bg-[linear-gradient(150deg,#0d0d0d_0%,#161616_50%,#1a1500_100%)] p-12 lg:flex">
          ...
          <div className="relative space-y-8">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#C9A227]/70">Business OS</p>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={item.text} className="flex items-start gap-3">
                  <span className="mt-0.5 text-[#C9A227]/60 text-xs">{item.icon}</span>
          ...
          <p className="relative text-[0.8125rem] text-white/60">© {new Date().getFullYear()} Duuka ProMax</p>
        </section>
        ...
        <section className="flex min-h-dvh items-center justify-center px-5 py-10 lg:min-h-0 lg:bg-[#0d0d0d] lg:px-12">
          <div className="w-full max-w-sm">
            ...
            <p className="mt-6 text-center text-xs text-white/60">
              ...
              <Link href="/login" className="text-[#C9A227]/70 transition hover:text-[#C9A227]">
                Sign in
              </Link>
            </p>
          </div>
