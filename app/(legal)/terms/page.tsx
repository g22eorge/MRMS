        ...
        <div className="prose-legal space-y-8 text-sm leading-relaxed text-white/65">
          ...
          <section>
            ...
            <p>
              ...
              Notify us immediately at <a href={`mailto:${CONTACT_EMAIL}`} className="text-[#C9A227] hover:underline">{CONTACT_EMAIL}</a> if
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              via Pesapal. All paid plans begin with a 30-day free trial.
            </p>
            <p className="mb-3">
          ...
          <section>
            ...
            <p>
              ...
              <Link href="/privacy" className="text-[#C9A227] hover:underline">Privacy Policy</Link>.
      ...
      <footer className="border-t border-white/8 px-4 py-6 md:px-6">
        <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-between gap-3">
          ...
          <nav className="flex gap-4">
            ...
            <Link href="/privacy" className="text-[0.75rem] text-white/60 transition-colors hover:text-white">Privacy Policy</Link>
          </nav>
        </div>
      </footer>
    </div>
