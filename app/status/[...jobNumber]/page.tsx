      ...
      <div className="mx-auto max-w-lg space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[0.8125rem] text-gray-400">Repair Status Tracker</p>
          </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
          ...
          <div className="bg-amber-50 border-b border-amber-100 px-5 py-4">
            <p className="text-[0.75rem] font-bold uppercase tracking-widest text-amber-600">Job Number</p>
          ...
          <div className="px-5 py-4 grid grid-cols-2 gap-4 border-b border-gray-100">
            <div>
              <p className="text-[0.75rem] font-bold uppercase tracking-widest text-gray-400">Received</p>
              <p className="mt-0.5 text-sm font-medium text-gray-700">{fmt(job.receivedAt)}</p>
              <p className="text-[0.8125rem] text-gray-400">{ageLabel}</p>
            </div>
            {job.completedAt ? (
              <div>
                <p className="text-[0.75rem] font-bold uppercase tracking-widest text-gray-400">Completed</p>
              ...
              <div>
                {timelineLabel ? (
                  <>
                    <p className="text-[0.75rem] font-bold uppercase tracking-widest text-gray-400">Est. Time</p>
                    <p className="mt-0.5 text-sm font-medium text-gray-700">{timelineLabel}</p>
                  </>
                ) : (
                  <>
                    <p className="text-[0.75rem] font-bold uppercase tracking-widest text-gray-400">Wait Time</p>
          ...
          {job.statusNote && (
            <div className="px-5 py-4 border-b border-gray-100 bg-amber-50/50">
              <p className="text-[0.75rem] font-bold uppercase tracking-widest text-amber-600">Update from our team</p>
          ...
          {!isClosed && (
            <div className="px-5 py-5">
              <p className="mb-4 text-[0.75rem] font-bold uppercase tracking-widest text-gray-400">Progress</p>
