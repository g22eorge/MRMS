  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        <Link href="/sales" className="dc-card px-3 py-2.5 transition hover:-translate-y-[2px] sm:p-5">
        ...
        <Link href="/sales?tab=leads&status=WON" className="dc-card px-3 py-2.5 transition hover:-translate-y-[2px] sm:p-5">
        ...
        <Link href="/sales?tab=quotations" className="dc-card px-3 py-2.5 transition hover:-translate-y-[2px] sm:p-5">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 lg:grid-cols-4">
        ...
        <Link href="/documents/invoices" className="dc-card px-3 py-2.5 transition hover:-translate-y-[2px] sm:p-5">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 lg:grid-cols-3">
        ...
        <Link href="/pos" className="dc-card px-3 py-2.5 transition hover:-translate-y-[2px] sm:p-5">
