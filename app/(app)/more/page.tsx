  ...
  return (
    <div className="pb-6">
      ...
      <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
        ...
        {can.viewIntake(perm) && (
          <NavRow href="/intake" iconBg="bg-[var(--accent)]/15"
            description="Receive devices and log new repairs"
            icon={<ItemIcon d={["M22 12h-6l-2 3h-4l-2-3H2", "M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"]} color="text-[var(--accent)]" />}
          />
        )}

        {can.viewClientInfo(perm) && (
          <NavRow href="/clients" iconBg="bg-sky-500/15"
        ...
        {["ADMIN","OPS","TECHNICIAN_INTERNAL","MANAGER"].includes(user.role) && ok("INVENTORY") && (
          <NavRow href="/inventory" iconBg="bg-amber-500/15"
        ...
        {user.role !== "TECHNICIAN_EXTERNAL" && (
          <NavRow href="/technicians" iconBg="bg-violet-500/15"
        ...
        {["ADMIN","OPS","MANAGER"].includes(user.role) && (
          <NavRow href="/inventory/suppliers" iconBg="bg-emerald-500/15"
        ...
        {ok("COMPLAINTS") && ["ADMIN","MANAGER","TECH_MANAGER","OPS"].includes(user.role) && (
          <NavRow href="/complaints" iconBg="bg-red-500/15"
        ...
        {can.createLeads(perm) && ok("SALES") && (
          <NavRow href="/sales" iconBg="bg-pink-500/15"
        ...
        {can.manageFieldVisits(perm) && ok("FIELD") && (
          <NavRow href="/field" iconBg="bg-teal-500/15"
      ...
      {can.viewFinancials(perm) && (
        <>
          ...
          <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
            ...
            {ok("INVOICING") && (
              <>
                <NavRow href="/documents/job-cards" iconBg="bg-blue-500/15"
                ...
                />
                <NavRow href="/documents/quotations" iconBg="bg-amber-500/15"
                ...
                />
                <NavRow href="/documents/invoices" iconBg="bg-violet-500/15"
                ...
                />
                <NavRow href="/documents/receipts" iconBg="bg-emerald-500/15"
                ...
                />
                <NavRow href="/documents/delivery-notes" iconBg="bg-sky-500/15"
                  icon={<ItemIcon d={["M1 3h15v13H1z","M16 8h4l3 3v5h-7V8z"]} color="text-sky-500" />}
                />
                <NavRow href="/documents/credit-notes" iconBg="bg-rose-500/15"
                ...
                />
                <NavRow href="/documents/refunds" iconBg="bg-red-500/15"
      ...
      {["ADMIN","OPS","FRONT_DESK","MANAGER"].includes(user.role) && ok("POS") && (
        <>
          ...
          <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
            <NavRow href="/pos" iconBg="bg-purple-500/15"
            ...
            {["ADMIN","OPS","FRONT_DESK","MANAGER"].includes(user.role) && (
              <NavRow href="/pos/shifts" iconBg="bg-indigo-500/15"
        ...
        <>
          ...
          <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
            ...
            {can.manageUsers(perm) && (
              <NavRow href="/settings/users" iconBg="bg-blue-500/15"
            ...
            {["ADMIN","MANAGER"].includes(user.role) && (
              <NavRow href="/settings/branches" iconBg="bg-teal-500/15"
            ...
            {can.viewAccountsSummary(perm) && (
              <NavRow href="/reports" iconBg="bg-amber-500/15"
            ...
            {can.viewAccountsSummary(perm) && (
              <NavRow href="/ai-insights" iconBg="bg-violet-500/15"
            ...
            {["ADMIN"].includes(user.role) && (
              <NavRow href="/settings/data-heal" iconBg="bg-orange-500/15"
      ...
      <div className="divide-y divide-[var(--line)]/50 rounded-2xl border border-[var(--line)] bg-[var(--panel)] mx-2 overflow-hidden">
        <NavRow href="/settings/notifications" iconBg="bg-blue-500/15"
        ...
        />
        <NavRow href="/settings/profile" iconBg="bg-emerald-500/15"
