...
export default async function AppLayout({
  ...
  return (
    <div className="min-h-dvh overflow-x-clip md:h-dvh md:flex md:overflow-clip">
      <AppSidebar role={user.role} permissions={user.permissions} />
      <div className="relative flex min-h-screen min-w-0 flex-1 flex-col overflow-x-clip md:h-full md:overflow-clip">
