  ...
  return (
    <div className="min-h-dvh overflow-x-clip md:flex md:h-screen md:overflow-hidden">
      ...
      <div className="relative flex min-h-screen min-w-0 flex-1 flex-col overflow-x-clip md:h-full md:min-h-0">
        <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top_right,rgba(201, 162, 39,0.06),transparent_50%),radial-gradient(ellipse_at_bottom_left,rgba(201, 162, 39,0.04),transparent_40%)]" />
