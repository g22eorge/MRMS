...
export default async function AiSettingsPage({ searchParams }: { searchParams: Promise<{ saved?: string }> }) {
  ...
  return (
    <section className="space-y-4">
      ...
      <form action={saveSettingsAction} className="dc-card px-3 py-2.5">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <div className="dc-card px-3 py-2.5"><p className="text-xs text-[var(--ink-muted)]">Helpful</p><p className="text-lg font-bold text-emerald-600">{helpful}</p></div>
        <div className="dc-card px-3 py-2.5"><p className="text-xs text-[var(--ink-muted)]">Not helpful</p><p className="text-lg font-bold text-amber-600">{notHelpful}</p></div>
        <div className="dc-card px-3 py-2.5"><p className="text-xs text-[var(--ink-muted)]">Prompt logs</p><p className="text-lg font-bold text-[var(--ink)]">{promptLogs.length}</p></div>
      </div>

      <div className="grid gap-4 xl:grid-cols-[0.9fr_1.1fr]">
        <form action={createArticleAction} className="dc-card space-y-3 px-3 py-2.5">
