  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-[var(--line)] bg-[var(--panel)] p-5">
        <p className="mb-3 text-[0.75rem] font-bold uppercase tracking-[0.16em] text-[var(--ink-muted)]">Subscription Pricing (UGX)</p>
        <div className="grid gap-3 sm:grid-cols-2">
          {(["GROWTH", "ENTERPRISE"] as const).map((plan) => (
            <div key={plan} className="rounded-lg border border-[var(--line)] bg-[var(--panel-strong)] px-4 py-3">
              <p className="text-[0.75rem] font-bold uppercase tracking-wide text-[var(--ink-muted)]">{plan}</p>
      ...
      {/* Environment */}
      <div className="rounded-xl border border-[var(--line)] bg-[var(--panel)] p-5">
        <p className="mb-2 text-[0.75rem] font-bold uppercase tracking-[0.16em] text-[var(--ink-muted)]">Environment</p>
