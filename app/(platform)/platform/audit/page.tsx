        ...
        columns={[
          {
            key: "when",
            header: "When",
            className: "align-top whitespace-nowrap text-xs text-[var(--ink-muted)]",
          ...
          },
          {
            ...
            cell: (event) => {
              ...
              return actor ? <span>{actor.name}<br /><span className="font-mono">{actor.email}</span></span> : event.actorUserId ?? "—";
            },
          },
          {
            key: "entity",
          ...
          },
          {
            key: "after",
            header: "After",
            className: "align-top max-w-[260px] font-mono text-xs text-[var(--ink-muted)]",
